/*
01 - Neste diretório (exercicio-01), há um index.html vazio. [x]
...
"JS is Awesome!" em um alert no browser. [x]
...
/*
04 - Comente o alert que você escreveu acima, utilizando o comentário de uma linha. - [x]
*/
...
/*
06 - Declare uma const "currentYear", que recebe o ano atual, com 4 dígitos. - [x]
*/
const currentYear = 2023

/*
07 - Exiba as const "myBirthYear" e "currentYear", lado a lado, no console do browser. - [x]
*/
...
matemáticas e strings (textos) em breve =) - [x]
*/
const ten = 10
