...
- Inicie o seu servidor local e abra o console do browser. - [x]
*/

/*
02 - Armazene um array vazio em uma let "brazilianFoods"; - [x]
*/
let brazilianFood = []
...
- Exiba a brazilianFoods no console. - [x]
*/
...
- Exiba apenas o 2º item desse array no console. - [x]
*/
brazilianFood[1] = 'Pão de Queijo'
...
- Exiba a foodsInfo no console. - [x]
*/
const foodsInfo = `Até aqui, o  
array "brazilianFoods" possui ${brazilianFood.length} itens: ${brazilianFood[0]}, ${brazilianFood[1]} e ${brazilianFood[2]}`
...
- O resultado deve ser: "nome1, nome2, nome3, nome4". - [x]
*/
...
- Utilize o método adequado para isso. - [x]
*/
...
const dessert = `${dogNames[0].slice(3)}${dogNames[1].slice(2)}${dogNames[3]
  .slice(2)
  .replace('n', 'd')}`
const phrase = `A ${dessert} é um doce à base de coco, tradicional na América Latina e em Angola.`
// console.log(phrase)
