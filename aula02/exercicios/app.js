...
const numberGreaterThan50 = randomNumbers.find(n => n > 50)
...
const cookedIngredients = ingredients.reduce(
  (acc, ingredient, index, array) => {
    // const lastWord = ingredient[ingredient.length - 1]
    // const correctWordGender = lastWord === 'a' ? 'cozida' : 'cozido'
