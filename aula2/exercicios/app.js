/*
01 - No index.html deste diretório (exercicio-02): - [x]
...
/*
02 - Inicie o seu servidor local e abra o console do browser. - [x]
*/

/*
03 - Exiba a string 'Grandes poderes trazem grandes responsabilidades.' no console do browser. - [x]

Utilize os espaços entre os comentários abaixo para executar os códigos dos exercícios. Inclusive este. - [x]
*/
...
- Exiba a "myFavoriteTom" no console do browser. - [x]
*/
...
- Exiba a "js" no console do browser; - [x]
*/
...
- Exiba a "mdn" no console do browser; - [x]
*/
...
- Exiba no console do browser a quantidade de caracteres que a constante "programmingLanguage" possui; - [x]
*/
...
- Dica: utilize a propriedade ".length". - [x]
*/

let randomWord = 'Araponga'
let lastCharacter = randomWord.length - 1
// console.log(randomWord[lastCharacter])
...
- Não digite a nova string manualmente. - [x]
*/
...
- Exiba, no console, o index do caractere "v" da "winterMessage"; - [x]
*/
...
- Exiba, no console, o index da última ocorrência do caractere "n" da "winterMessage". - [x]
*/
...
- Não digite a string "J.K." manualmente; - [x]
*/
...
- Exiba a "realBestMovie" no console. - [x]
*/
...
- Exiba a reminder no console. O resultado deve ser 1;- [x]
*/
...
- O valor exibido no console deve ser 7. - [x]
*/
...
- O valor exibido no console deve ser 6. - [x]
*/
...
- Após a atribuição, exiba a let "episodes" no console. - [x]
*/
...
- Exiba a "allEpisodes" no console. - [x]
*/
