...
const numbers = [5, 7, 3]
const squadNumbers = numbers.map(number => number ** 2)
...
const nameProduct = cart.reduce((acc, { name }) => `${acc}- ${name}\n`, '')
...
const moveisBefore2000 = tarantinoMovies.filter(({ release }) => release < 2000)
console.log(moveisBefore2000)
