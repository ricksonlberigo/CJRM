...
let dog = {
  ...
  age: 3,
  color: 'white',
  bestFriends: ['Rickson', 'Vanessa', 'Alex'],
  sound: function () {
    return 'Auau'
  },
}
...
const combinedAgeBetweenCatAndDog = cat.age + dog.age

console.log(
  `A soma das idades de ${catName} e ${dogName} é ${combinedAgeBetweenCatAndDog}.`,
)
...
const isAnSUV = car =>
  ['Honda HR-V', 'Jeep Renegade', 'Ford EcoSport', 'Hyundai iX35'].includes(car)
...
const getTypeDefinition = type => {
  ...
  // Pode ocorrer de alguns códigos estar assim
  return {
    null: 'Seta, explicitamente, uma variável sem valor.',
    undefined: 'Representa um valor não-setado.',
    object: 'Arrays, Datas, Objetos literais, Funções, etc.',
