...
/*
  ...
  - Exiba o objeto no console.
*/
const past = new Date('January 01 2023 01:00:00')
console.log(past)
...
const future = new Date('December 25 2023 23:00:00')
console.log(future)
...
const differenceInDays = convertDays(difference)
...
/*
  ...
  por conta própria, considere inseri-la como parte de seu portfólio.
