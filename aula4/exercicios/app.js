/*
  ...
  "Minhas 3 séries favoritas são: SÉRIE_01, SÉRIE_02 e SÉRIE_03." - [x]
*/
...
const sentence = `Minhas 3 séries favoritas são: ${my3FavoriteTvShows
  .slice(0, -1)
  .join(', ')} e ${my3FavoriteTvShows[my3FavoriteTvShows.length - 1]}`
...
/*
  ...
  - Exiba no console o boolean que a "isRandomTVShowIncluded" recebeu. - [x]
*/
...
/*
  ...
  "O tipo de dado que a const "isRandomTVShowIncluded" armazena é: TIPO_DE_DADO." - [x]
*/
...
/*
  ...
  caracteres? BOOLEAN." - [x]
*/
const result = typeSentence.length === 39

let boolean = String(result)
const phrase = `A string que a "typeSentence" armazena tem mais de 39  
caracteres? ${boolean.slice(0, 1).toLocaleUpperCase() + boolean.slice(1)}.`
// console.log(phrase)
...
// Todo número somado a null é ele mesmo, e como número 1 é um valor inteiro positivo, então ele se torna um true
...
/*
  ...
  - Exiba a "isNotAString" no console. - [x]
*/
...
/*
  ...
  - Não utilize o método includes desta vez. - [x]
*/

const evenNumbers = [0, 2, 4, 6, 8, 10]
const numberToCheck = evenNumbers.indexOf(8)
// console.log(numberToCheck !== -1)
